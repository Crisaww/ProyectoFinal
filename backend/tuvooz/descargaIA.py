...
def synthesize_text_to_speech(text, output_file='WomanBuenasNoches.wav', voice_name="fr-FR-Neural2-C", language_code="fr-FR", audio_format=texttospeech.AudioEncoding.LINEAR16, speaking_rate=1.0):

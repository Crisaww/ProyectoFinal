...
def synthesize_text_to_speech(text, output_file='output.mp3', voice_name="en-US-Journey-D", language_code="en-US", audio_format=texttospeech.AudioEncoding.LINEAR16, speaking_rate=1.0):
